        ...
        <template #body>
            ...
            <div class="h-[calc(100% - 60px)]">
                <el-table border :data="tableData" size="small" highlight-current-row stripe>
                    ...
                    <el-table-column prop="fileName" label="文件名称" width="90" show-overflow />
                    <el-table-column prop="fileType" label="文件类型" width="90" show-overflow />
                    <el-table-column prop="mark" label="备注" show-overflow />
                    <el-table-column label="操作" width="190" align="center" fixed="right">
                        <template v-slot="{ row }">
                            <el-button type="primary" link size="small"
                                @click="onEditScriptClick(row)">编辑脚本</el-button>
        ...
        <template #body>
            <el-form label-width="auto" :model="dataForm" :rules="rules" ref="dataFormRef">
                ...
                <el-form-item label="文件名称" prop="fileName">
                    <el-input v-model="dataForm.fileName" placeholder="请输入文件名称" clearable />
                </el-form-item>
